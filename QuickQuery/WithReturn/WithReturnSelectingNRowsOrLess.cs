namespace QckQuery
{
    ...
    public partial class QuickQuery
    {
        ...
        /// </exception>
        public IEnumerable<T> WithReturnSelectingNRowsOrLess<T>(string sql, int n, object parameters) where T : new()
        {
            return WithReturnSelectingNRows(sql, n, true, DictionaryMaker.Make(parameters)).ToObject<T>();
        }
        ...
        /// A column of the DataTable doesn't match any in the given class
        /// </exception>
        public IEnumerable<T> WithReturnSelectingNRowsOrLess<T>(string sql, int n, params object[] parameters)
            where T : new()
        {
            return WithReturnSelectingNRows(sql, n, true, DictionaryMaker.Make(parameters)).ToObject<T>();
        }
