namespace QueryLibrary
{
    ...
    public sealed partial class Query
    {
        ...
        /// </exception>
        public DataTable SelectNoLessThan(int n, string sql, object parameters = null)
        {
            if (_disposed)
        ...
        /// </exception>
        public IEnumerable<T> SelectNoLessThan<T>(int n, string sql, object parameters = null) where T : new()
        {
            if (_disposed)
                throw new ObjectDisposedException(GetType().FullName);
