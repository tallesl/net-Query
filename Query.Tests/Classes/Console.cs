namespace QueryLibrary.Tests
{
    public class Console
    {
        ...
        public override bool Equals(object obj) => obj is Console ? this == (Console)obj : false;

        public override int GetHashCode() =>
            Id.GetHashCode() ^
            Name.GetHashCode() ^
            HomeConsole.GetHashCode() ^
            PortableConsole.GetHashCode();
        ...
        public static bool operator !=(Console a, Console b) => !(a == b);
    }
}
